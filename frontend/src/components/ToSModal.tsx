...
export default function ToSModal({ onAgree }: ToSModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative w-[95vw] max-w-lg max-h-[95vh] overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-gray-800">
        {/* Close Button */}
        <button
          onClick={handleAgree}
        ...
        <div className="p-6">
          ...
          <div className="overflow-y-auto scrollbar-hide max-h-[70vh] space-y-4 text-sm text-gray-700 dark:text-gray-200">
            <p>
